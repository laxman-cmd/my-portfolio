...
import { CircularText, MyCircularText } from './icons';
...
const HireMe = () => {
  return (
    ...
    flex items-center justify-center overflow-hidden md:right-auto
    md:left-8 md:top-0 md:bottom-auto  md:absolute
    '
    >
      <div
      ...
      '
      >
        {/* <MyCircularText className={'fill-dark animate-spin-slow'} /> */}
